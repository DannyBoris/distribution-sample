      ...
      <div style={{padding:'0 70px'}}>
        ...
        <Card>
          <Row align="top" justify="space-between">
            <Row gutter={25}>
              <Image preview={false} src={release.image.largeExternalUrl} />
              <Col>
                ...
                <DetailsRow type="Genre" value={release.primaryMusicStyleId} />
                <DetailsRow
                  type="Subgenre"
                  value={release.secondaryMusicStyleId}
                />
                <DetailsRow type="Copyright Year" value={release.copyrights} />
